...
public class SolutionsTest {
    ...
    public void testSingle() {
        for (int i = 0; i < TestUtility.SOLUTIONS_ONE.length; i++) {
            String test = TestUtility.SOLUTIONS_ONE[i][0];
            String reference = TestUtility.SOLUTIONS_ONE[i][1];
    ...
    public void testMulti() {
        for (int i = 0; i < TestUtility.SOLUTIONS_MULTI.length; i++) {
            String test = TestUtility.SOLUTIONS_MULTI[i][0];
            int sols = TestUtility.SOLUTIONS_MULTI[i].length - 1;
            String[] result = LinkGame.getSolutions(test);
            ...
            for (int j = 1; j <= sols; j++) {
                solset.add(TestUtility.SOLUTIONS_MULTI[i][j]);
            }
